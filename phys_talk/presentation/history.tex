...
%\begin{frame}{Natural Philosophy Pre Early Modern Period}
	...
	%\end{itemize}
%\end{frame}
\section{Isaac Newton (1642-1727)}
\begin{frame}{Newtonian Mathematical Ideals}
	\begin{itemize}
		\item \onslide Saw God as mathematical, with a fondness for geometry\textsuperscript{ii}
		...
		\item Would have grown up with Cartesianism (deductive reasoning), but clashed with it later in life\autocite{westfall}
	...
	\end{itemize}
	\customfootnotetext{ii}{Newton's piety would greatly influence his work}
\end{frame}
...
\begin{frame}{Maxwell \& Vectors}
	...
	\end{itemize}
\end{frame}
\section{Aether Theory \& Special Relativity}%
...
\begin{itemize}
	...
	\item  The nature of the aether{ \textsuperscript{iv}} was hotly debated
...
\end{frame}
\begin{frame}{Henri Poincaré (1854-1912)}
	\begin{itemize}
